    ...
    <section class="text-gray-600 body-font">
        <div class="container px-5 py-24 mx-auto">
                    ...
                    <tbody>
                        @foreach ($quiz->options as $quizOption)
                            <tr>
                                ...
                                <td class="px-4 py-3">{{ $quizOption['is_correct'] === 1 ? '⭕️' : '❌' }}</td>
                                <td class="px-4 py-3">
                                    {{-- 選択肢したidが選んだidと同じかどうか --}}
                                    {{-- 第一引数は検索したいid,第二は対象の配列 --}}
            ...
            <div class="flex pl-4 mt-4 lg:w-2/3 w-full mx-auto">
                <button onclick="location.href='{{ route('categories.quizzes', ['categoryId' => $categoryId]) }}'"
