    ...
    <section class="text-gray-600 body-font relative mt-5">
        <div class="container px-5 py-6 mx-auto">
            <div class="flex flex-col text-center w-full mb-12">
                <h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">カテゴリー 一覧</h1>
            </div>
            <div class="sm:w-1/2 ml-auto">
                <div class="flex flex-wrap -m-2">
                    <div class="p-2 w-full">
                        <button onclick="location.href='{{ route('admin.categories.create') }}'"
                            class="flex mx-auto text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">カテゴリー新規登録</button>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="px-4 py-3 text-lg text-gray-900">
                                ...
                                {{-- カテゴリー詳細ページに遷移 --}}
                                    class="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">詳細
                                </button>
                            </td>
                            <td class="px-4 py-3 text-lg text-gray-900">
                                <form method="POST" action="{{ route('admin.categories.destroy', ['categoryId' => $category->id]) }}">
                                    ...
                                    <button
                                        type="submit"
                                        class="flex ml-auto text-white bg-pink-500 border-0 py-2 px-6 focus:outline-none hover:bg-pink-600 rounded">削除
                                    </button>
                                </form>
                            </td>
                        </tr>
