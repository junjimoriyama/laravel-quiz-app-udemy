                ...
                <form method="POST" action="{{ route('admin.categories.quizzes.store', ['categoryId' => $categoryId]) }}" class="flex flex-wrap -m-2">
                    ...
                    <div class="p-2 w-full">
                        <div class="relative">
                            ...
                            <textarea id="question" name="question"
                                class="w-full bg-gray-50 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 h-32 text-base outline-none text-gray-700 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out">{{ old('question') }}</textarea>
                        </div>
                    ...
                    <div class="p-2 w-full">
                        <div class="relative">
                            ...
                            <textarea id="explanation" name="explanation"
                                class="w-full bg-gray-50 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 h-32 text-base outline-none text-gray-700 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out">{{ old('explanation') }}</textarea>
                        </div>
                    ...
                    <div class="p-2 w-full">
                        <div class="relative">
                            ...
                            <input type="text" id="content{{ $i }}" name="content{{ $i }}" value="{{ old('content'.$i) }}"
                    ...
                    <div class="p-2 w-full">
                        <div class="relative">
                            ...
                            <select
                                id="isCorrect{{ $i }}" name="isCorrect{{ $i }}"
